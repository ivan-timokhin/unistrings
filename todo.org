...
** TODO Consider switching to =megaparsec=
...
* Organisational tasks [0/4]
** NEXT Use ~extracted/~ files for numeric properties
That will cut the dependency on Unihan.
** TODO Remove the explicit version dependence
Currently, everything hardcodes =latest= as a path component; I probably don't want that.
** TODO Sort out fetch scripts
