...
{- HLINT ignore -}
{-# LANGUAGE MagicHash #-}
module Data.UCD.Internal.PatternSyntax (retrieve) where
...
foreign import ccall "&_hs__ucd__pattern_syntax_layer_0" layer_0 :: Ptr Int8
foreign import ccall "&_hs__ucd__pattern_syntax_layer_1" layer_1 :: Ptr Int8
foreign import ccall "&_hs__ucd__pattern_syntax_layer_2" layer_2 :: Ptr Int8
foreign import ccall "&_hs__ucd__pattern_syntax_layer_3" layer_3 :: Ptr Int8
foreign import ccall "&_hs__ucd__pattern_syntax_bottom" bottom :: Ptr Int8
