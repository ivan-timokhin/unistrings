...
{- HLINT ignore -}
{-# LANGUAGE MagicHash #-}
module Data.UCD.Internal.NfkdQuickCheck (retrieve) where
...
foreign import ccall "&_hs__ucd__nfkd_quick_check_layer_0" layer_0 :: Ptr Int8
foreign import ccall "&_hs__ucd__nfkd_quick_check_layer_1" layer_1 :: Ptr Int8
foreign import ccall "&_hs__ucd__nfkd_quick_check_layer_2" layer_2 :: Ptr Word8
foreign import ccall "&_hs__ucd__nfkd_quick_check_layer_3" layer_3 :: Ptr Int8
foreign import ccall "&_hs__ucd__nfkd_quick_check_bottom" bottom :: Ptr Int8
